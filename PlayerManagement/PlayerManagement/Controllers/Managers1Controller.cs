...
//    [ApiController]
//    public class Managers1Controller : ControllerBase
//    {
//        private readonly AppDbContext db;
//        private readonly IWebHostEnvironment web;

//        public Managers1Controller(AppDbContext db, IWebHostEnvironment web)
//        {
//            this.db = db;
//            this.web = web;
//        }
...
//                Email = c.Email,
//                IsActive = c.IsActive,
//                ManagerTrainers = c.ManagerTrainerAssignments.Select(cs => new ManagerTrainerAssignmentReadDto
//                {
//                    TrainerId = cs.TrainerId,
//                    Name = cs.Trainer.TrainerName,
...
//                ManagerTrainers = manager.ManagerTrainerAssignments.Select(cs => new ManagerTrainerAssignmentReadDto
//                {
//                    TrainerId = cs.TrainerId,
//                    Name = cs.Trainer.TrainerName,
//                    JoiningDate = cs.JoiningDate
...
//            };
//            if (!string.IsNullOrEmpty(managerDto.ManagerTrainersJson))
//            {
//                var managerTrainerAssignmentDtos = JsonConvert.DeserializeObject<List<ManagerTrainerAssignmentDto>>(managerDto.ManagerTrainersJson);
...
//                ManagerTrainers = savedManager.ManagerTrainerAssignments.Select(cs => new ManagerTrainerAssignmentReadDto
//                {
//                    TrainerId = cs.TrainerId,
//                    Name = cs.Trainer.TrainerName,
//                    JoiningDate = cs.JoiningDate
